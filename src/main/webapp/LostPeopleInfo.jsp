...
<body>
<form enctype="multipart/form-data" action="lost.form" method="post" onsubmit="return check()">
    <div class="div1">
    ...
    <div class="div2 borderstyle">
        ...
        <select id="selecttype" name="selecttype" class="selectbox" onchange="selectfunc()">
            <option value="0" selected>刚刚走失</option>
            <option value="1">走失多年</option>
        </select>
    </div>
    <div class="div3 borderstyle">
        ...
        <div class="infodet">
            ...
            <div class="lb">性别</div>
            <input type="radio" name="rd" class="radiotype" value='男' onchange="sexchange(this.value)"><div class="radiotxt">男</div>
            <input type="radio" name="rd" class="radiotype" value='女' onchange="sexchange(this.value)"><div class="radiotxt">女</div>
        </div>
         <div class="infodet">
