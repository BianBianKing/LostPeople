    ...
    e.fn.poptrox=function(o){
        ...
        if(this.length>1){
            for(var i=0;i<this.length;i++)
                e(this[i]).poptrox(o);return e(this)
        }
        var p,s,r=e.extend({
            preload:!1,
            baseZIndex:1e3,
        ...
        var v=x.find(".pic"),
            w=e(),b=x.find(r.popupLoaderSelector),
